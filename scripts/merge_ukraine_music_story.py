...
"""
    ...
    block4 = """
      <div class="prose-block">
        ...
        <p>
          Є лейбли, відомі <strong>тим, що створюють успішних артистів</strong> і просувають їх на ширші ринки. Ми визначаємо <strong>топовий лейбл</strong> як такий, що має щонайменше <strong>двох артистів, кожен із яких досяг 270&thinsp;960+ місячних слухачів Spotify</strong> — приблизно <strong>$300</strong> за підрахунками стримінгових виплат.
        </p>
...
"""
    ...
    block8 = """
      <div class="prose-block">
        ...
        <aside class="story-aside">
          <p>
            Ukrainian phonk виріс із глобальної хвилі фонку — мемфіських лупів і трап-енергії, що вибухнули на SoundCloud і у короткометражних відео — і набув локального акценту завдяки таким колективам, як <strong>Ukrainian Phonk Community</strong>. Сьогодні він часто незалежний, з важким басом і невіддільно "нічно-інтернетний," з аудиторією як вдома, так і за кордоном.
          </p>
        </aside>
        </div>
      </div>
    ...
    <section class="chart-section" aria-labelledby="sec-deals">
      <div class="prose-block" style="padding-bottom:1rem">
        <p class="section-label">
          ...
          <span class="ua-only">Розділ 6 · Підписання</span>
        </p>
        <h2 id="sec-deals">
